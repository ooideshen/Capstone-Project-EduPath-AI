...
(async () => {
  try {
    ...
    console.log('Testing AcademicAssessment/add...');
    const payload = JSON.stringify({
      track: 'SPM',
      malayGrade: 'A',
      englishGrade: 'A'
    });
    const assessRes = await makeRequest(API_URL + '/api/AcademicAssessment/add', { 
      method: 'POST',
      headers: { 
    ...
    console.log('Assessment response:', assessRes.status);
    console.log('Assessment body:', assessRes.data);
